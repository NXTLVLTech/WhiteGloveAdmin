...
db.collection("bookings").orderBy("bookedAt", "desc").get().then((querySnapshot) => {
    querySnapshot.forEach((doc) => {
        db.collection("users").doc(doc.data().uid).get().then((innerQuerySnapshot) => {
			// innerQuerySnapshot.forEach((innerDoc) => {
				$increment++;
				$firstName=innerQuerySnapshot.data().firstName!=null?innerQuerySnapshot.data().firstName:'';
				$lastName=innerQuerySnapshot.data().lastName!=null?innerQuerySnapshot.data().lastName:'';
				$email=innerQuerySnapshot.data().email!=null?innerQuerySnapshot.data().email:'';
				$bookedAt=doc.data().bookedAt!=null?doc.data().bookedAt:'';
				$destination=doc.data().destination!=null?doc.data().destination:'';
				$pickupDate=doc.data().pickupDate!=null?doc.data().pickupDate:'';
				$userLocation=doc.data().userLocation!=null?doc.data().userLocation:'';
				$("#table_body").append("<tr class='border_bottom' id ="+doc.id+">"+
											...
											" <td><b>"+$pickupDate+"</b></td>"+
											" <td><b>"+$userLocation+"</b></td>"+
...
<title>WhiteGlove-Bookings</title>
		...
		-->
			...
			<div class="sidebar-wrapper">
				<div class="user">
					...
					<div >
						<ul class="nav">
							<li><a href="../users.php"><span class="sidebar-normal"></span>Users</a></li>
							<li style="background-color: rgb(255,255,255);"><a href="../bookings.php"><span class="sidebar-normal" style="color:#000000">Bookings</span></a></li>

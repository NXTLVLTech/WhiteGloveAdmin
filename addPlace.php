...
function getPath(){
    ...
    <title>WhiteGlove-Add Place</title>
                            ...
                            <div class="card wizard-card" data-color="rose" id="wizardProfile">
                                <form action="" method="">
                                    ...
                                    <div style="background-color: #000000;">
                                        <ul>
                                            <li>
                                                <a href="#about" data-toggle="tab"><b style="color:white;">New Place</b></a>
                                            </li>
                                        ...
                                        <div class="tab-pane" id="about">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
													...
													<p>Select Category</p>
													<input type="radio" name="placeCategory" value="dinnerreservation" checked="true">Dinner Reservation<br>
													<input type="radio" name="placeCategory" value="featured">Featured<br>
													<input type="radio" name="placeCategory" value="realestate">Real Estate<br>
													<input type="radio" name="placeCategory" value="experiance">Experiences<br>                                                    
													<input type="radio" name="placeCategory" value="barber">Barber<br>                                                    
													<input type="radio" name="placeCategory" value="concierge">Concierge<br>                                                    
													<input type="radio" name="placeCategory" value="bottleservice">Bottle Service<br>                                                    
                                                </div>                                                
                                            </div>                                        
                                        </div>                                    
                                    </div>
									...
									<div  id = "loaderid" style="display:none;"> 
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <input type='button' onclick="getPath()"  data-background-color="black" class='btn btn-finish btn-fill btn-orange btn-wd' name='finish' value='Finish' />
                                        </div>
                                        <div class="pull-left">
